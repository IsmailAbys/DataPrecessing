...
def z_scale_factor(data):
    ...
    for i in range(len(data)):
        ...
        z_sc_f = 120/ data[i].shape[1]
        z_scale_factors.append(z_sc_f)


    for i in range(len(data)):
        scale_factor = [1,z_scale_factors[i],1]
...
downsampled_data = downsampling(train_data)



# index = np.random.randint(0, len(downsampled_data)-1)
# print(index)
nifti_file = nib.Nifti1Image(downsampled_data[1], None)
nib.save(nifti_file, os.path.join(r"D:\toto\sujetfrac.nii.gz")) 
print(" c'est fait ")