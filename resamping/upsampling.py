...
index = np.random.randint(0, len(upsampled_data)-1)
nifti_file = nib.Nifti1Image(upsampled_data[index], np.eye(4))
nib.save(nifti_file, os.path.join("output path to save the upsampled image", '__filname__.nii.gz')) 